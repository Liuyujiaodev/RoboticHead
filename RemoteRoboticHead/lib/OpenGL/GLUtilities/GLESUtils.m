...
+(CMSampleBufferRef)copyRromBuffer:(CMSampleBufferRef)sampleBufferRef {
    
    CMSampleBufferRef detectSampleBufferRef = NULL;
    CMSampleBufferCreateCopy(kCFAllocatorDefault, sampleBufferRef, &detectSampleBufferRef);
    return detectSampleBufferRef;
}
